            ...
            card_body(
              ...
              selectInput(
                ...
                choices = c(
                  ...
                  "Consum de risc d'alcohol de la població de 15 anys i més (brut)" = "fitxa_SCES02",
                  "Consum de risc d'alcohol de la població de 15 anys i més (estandarditzat)" = "fitxa_SCES03",
